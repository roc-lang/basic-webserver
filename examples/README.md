...
Examples are reader-facing tests. Keep top-level functions annotated, use `?`
for setup that should fail fast, and run `roc check`, `roc test`, and `roc build`
for examples you change.
