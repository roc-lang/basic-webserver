...
const _SIZE_CHECK_union_InternalError: () =
    assert!(core::mem::size_of::<union_InternalError>() == 12);
const _ALIGN_CHECK_union_InternalError: () =
    assert!(core::mem::align_of::<union_InternalError>() == 4);
...
const _SIZE_CHECK_union_ConnectResult: () =
    assert!(core::mem::size_of::<union_ConnectResult>() == 20);
const _ALIGN_CHECK_union_ConnectResult: () =
    assert!(core::mem::align_of::<union_ConnectResult>() == 4);
...
impl GlueTypes {
    ...
    pub fn unwrap_M(mut self) -> WriteErr {
...
impl GlueTypes {
    ...
    pub fn M(payload: WriteErr) -> Self {
        Self {
