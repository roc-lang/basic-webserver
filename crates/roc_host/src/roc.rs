...
fn sqlite_prepare(
    ...
    match alloc_result {
        Ok(out) => {
            ...
            // That means they are part of the model.
            // Can do this by tracking allocations and frees of SqliteStatement during init.
            let rc_ptr = ThreadSafeRefcountedResourceHeap::<SqliteStatement>::box_to_refcount(&out);
            *rc_ptr = 0;
            RocResult::ok(out)
        }
